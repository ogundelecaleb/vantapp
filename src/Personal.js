      ...
      <section className="px-[16px] md:px-[60px]  lg:px-[120px] mb-[60px] md:mb-[100px] lg:mb-[120px]">
        <div className="w-full md:w-[50%] mb-[28px] md:mb-[36px] lg:mb-[56px]">
          ...
          <p className="text-[16px] md:text-[18px]  md:mb-[28px] mb-[16px]">
            ...
            of saving seamlessly, wherever and whenever suits you best. Whether
            it’s a quick deposit during your lunch break or setting up a fixed
            savings.
          </p>
        </div>
        ...
        <div className="flex items-center flex-col md:flex-row gap-[50px] ">
          <div className="w-full md:w-[50%]">
            <div className="bg-[#FCFCFC] pt-[20px] md:pt-[30px] lg:pt-[40px] px-[20px] md:px-[30px] lg:px-[40px] md: rounded-tl-[16px] rounded-tr-[16px]">
              ...
              <p className="text-[#5F5F60] mb-[20px] md:mb-[40px]">
                ...
                <br />
                <br />
                Keep money aside by setting specific goals over a period of time
                with a set deposit interval with vant.
              </p>
              <ScrollAnimation
